...
function Contact() {
  return (
    <div id="Contact" className='w-full flex flex-col  p-20'>
      ...
      <div>
        <h1 data-aos="fade-right" className='text-blue-400 font-semibold text-2xl'>Contact</h1>
        <h2 data-aos="fade-right" data-aos-delay="100" className='text-4xl font-bold py-5'>Don't be shy! Hit me up! 👇</h2>
      </div>
